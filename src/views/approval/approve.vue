<template>
    ...
    >
        ...
        <el-image
            :src="data.production_order_img"
            :zoom-rate="1.2"
            :preview-src-list="data.production_order_img"
            fit="cover"
        />
        <template #footer>
    ...
    >
        ...
        <el-image
            :src="data.material_get_img"
            :zoom-rate="1.2"
            :preview-src-list="data.material_get_img"
            fit="cover"
        />
        <template #footer>
            <span class="dialog-footer">
        ...
        approveResult(formName, id, status) {
            ...
            http({
                ...
                .then((res) => {
                    ...
                    this.productionOrderVisible = false;
                })
                .catch(function (error) {
                    ElMessage.error(error.message);
                });
