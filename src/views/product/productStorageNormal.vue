                    ...
                    <el-row :gutter="20">
                        ...
                        <el-col :span="6">
                            <el-input
                                ...
                                "
                                placeholder="请填写需要入库的数量"
                            ></el-input>
                        </el-col>
                        <el-col :span="6"
                            ><span style="line-height: 32px">{{
                                "剩余可入库：" + items.product_can_storage
                            }}</span></el-col
                        >
                        <el-col :span="3"
                            ><el-button
...
export default {
    ...
    methods: {
        submitForm() {
            ...
            if (this.productStorageNormalForm.product_storage_img == "") {
        ...
        getImageUrl(res) {
            this.productStorageNormalForm.product_storage_img = res.data.file_name;
